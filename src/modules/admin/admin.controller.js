...
import { clearTrialBookings, completeRefund, dashboard, searchBookings, settleBalance, updateAmount, updateGuestPricing, updateStatus } from './admin.service.js'
...
export const deleteBookings = asyncHandler(async (req, res) => res.json(await clearTrialBookings(String(req.body.confirmation || ''))))
