...
import { deleteBookings, getBookings, getDashboard, patchAmount, patchGuests, patchStatus, postCompleteRefund, postSettleBalance } from './admin.controller.js'

export const adminRouter = Router()
adminRouter.use(authenticate, requireAdmin)
adminRouter.get('/dashboard', getDashboard)
adminRouter.get('/bookings', getBookings)
adminRouter.delete('/bookings', deleteBookings)
